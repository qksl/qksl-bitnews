...
public enum UserSdkErrorCode implements BNErrorCode {
	...
	SUCCESS_REGISTRY("000000", "SUCCESS", "注册成功"),
	SUCCESS_SEND_CODE("000000", "SUCCESS", "验证码已发送"),
	...
	FORBIDDEN_CODE("001005", "Forbidden", "无效验证码"),
	...
	SMS_CONNECTION_VALIDATE("001012", "Fail to receive phone verification code", "获取短信验证码失败，你已经发送过验证码，请稍后再调用"), //
	USER_SMS_CHECK_RESULT_FAILURE("001013", "Fail to send phone verification code", "发送短信验证码失败"), //
	USER_SMS_CHECK_MOBILE_FAILURE("001013", "Fail to send phone verification code", "手机号验证失败"), //
	...
	MAIL_HASH_USED("001026", "Fail to receive email verification code", "邮箱已经被注册"), //
	...
	USER_MAIL_CHECK_PASSWORD_FAILURE("001035", "Incorrect email verification code", "邮箱密码输入有误"),//
	USER_MAIL_GET_TOKEN_FAIL("001045", "Incorrect email get token", "获取token失败"),//
	...
	DOUBLE_CLICK("010052", "double click", "操作异常，不允许重复点击"),
	...
	//竞猜异常
	GUESS_BAD_REQUEST("010101", "Invalid parameter", "查询不到本次竞猜"), //
	GUESS_BAD_REQUEST_UERSID("010101", "Invalid parameter", "查询id异常找不到"), //
	GUESS_BAD_REQUEST_TIME("010101", "Invalid parameter", "封盘时间不允许比当前时间小"), //
	GUESS_BAD_REQUEST_ERROR("010101", "Invalid parameter", "竞猜异常"), //
	GUESS_BAD_REQUEST_ClOSE("010101", "Validator failed", "本次竞猜已封盘"), //
	GUESS_BAD_REQUEST_SETTLEMENT("010101", "Validator failed", "本次竞猜已结束"), //
	GUESS_BAD_REQUEST_TYPE("010101", "Invalid parameter", "竞猜类型请填写"),
	GUESS_BAD_REQUEST_DISCUSSION("010101", "Invalid parameter", "相关资讯id请填写"),
	GUESS_BAD_REQUEST_USER("010101", "Insufficient permission", "用户权限不够，请进行大V认证"),

	//token
	TOKEN_BAD_REQUEST("010101", "Invoke service fail", "查询token失败"),
	TOKEN_BAD_LACK("010101", "Amount Lack", "账户金额不够"),
	//task
	TASK_BAD_REQUEST_FINISH("010101", "Invoke service fail", "任务已完成"),
	TASK_BAD_REQUEST_REWARD("010101", "Invoke service fail", "任务未达到领取条件"),
	;
